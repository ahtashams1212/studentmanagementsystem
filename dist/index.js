...
function saveDataToFile(students) {
    fs_1.default.writeFileSync(dataFilePath, JSON.stringify(students, null, 2), 'utf8');
}
async function main() {
    let students = readDataFromFile();
    function displayStudents() {
        console.log(chalk_1.default.bold('List of Students:\n'));
    ...
    async function addStudent() {
        ...
        console.log(chalk_1.default.green.bold('Student added successfully!\n'));
        displayStudents();
        promptAction();
    }
    function editStudent() {
        inquirer_1.default
            ...
            inquirer_1.default
                ...
                saveDataToFile(students);
                console.log(chalk_1.default.green.bold('Student information updated successfully!\n'));
                displayStudents();
                promptAction();
            });
        });
    ...
    function removeStudent() {
        inquirer_1.default
            ...
            saveDataToFile(students);
            console.log(chalk_1.default.red.bold(`Student ${removedStudent.name} removed successfully!\n`));
            displayStudents();
            promptAction();
        });
    }
        ...
        inquirer_1.default
            ...
            switch (answers.action) {
                ...
                case 'List Students':
                    ...
                    break;
                case 'Exit':
                    console.log(chalk_1.default.bold('Goodbye!'));
                    process.exit();
            }
        });
    }
    console.log(chalk_1.default.bold('Student Management System\n'));
    promptAction();
}
main();
